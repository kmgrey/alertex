...
<head>
    ...
    <title>Products | Alertex Wireless Critical Alert System</title>
    <meta name="description" content="Explore our wide range of mix and match Alertex Lockdown and Alertex Fire Alert products, suitable for a variety of applications.">
        ...
        <section class="top-hero section">
            <div class="outer-container flex-wrap">
                ...
                <div class="inner-container flex-column">
                    <h1>Products</h1>
                    <p class="p-head">
                        Explore the Alertex Wireless Critical Alert range. 
                        Various units can be added to one site to suit any scenario.
                    </p>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            Long wireless range between units
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
                            </svg>
                            Monitor and control system via PC
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <a href="./key-fob.php">
                    <div class="card">
                        ...
                        <div class="card-heading">
                            ...
                            <h3>Wireless Key Fob</h3>
                        </div>
                    </div>
                </a>
                <!-- H E A T  &  S M O K E  D E T E C T O R S -->
                <!--
                <a href="">
                    <div class="card">
                        <div class="image-container blue-border">
                            <img src="alertex-lineup.png" alt="">
                        </div>
                        <div class="card-heading">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-double-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z"/>
