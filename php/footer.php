...
<footer id="global-footer-1">
    ...
    <div id="newsletter">
        ...
        <div>
            Stay up to date with the latest Alertex updates, news, and 
            legislations relating to Lockdown systems
        </div>
        <form id="newsletter-form" action="https://formsubmit.co/info@luminite.co.uk" method="POST">
            <fieldset>
                <input type="text" id="first-name" name="first-name" placeholder="First name*" required>
                <input type="text" id="last-name" name="last-name"  placeholder="Last name*"required>
                <input type="email" id="email" name="email" placeholder="Email address*" required>
                <input type="text" id="company" name="company" placeholder="Company / School*" required>
                <input type="hidden" name="_subject" value="Alertex Newsletter Signup">
                <input type="hidden" name="_next" value="https://alertex.co.uk/">
    ...
    <div id="footer">
        ...
        <div id="footer-bottom">
            <div class="social-icons">
                <a href="https://www.linkedin.com/company/luminite-electronics-ltd/">
            ...
            <div class="copyright">
                Copyright &copy Luminite Electronics Ltd. 2024
            </div>
            <div class="image-container">
                <img src="./images/logos/britain-badge.png" alt="Made in Britain badge">
            </div>
        </div>
    </div>
    <!-- C O O K I E  B A R -->
